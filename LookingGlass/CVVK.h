...
public:
	...
	virtual void Update2(Texture& Tex, const cv::Mat CVImage, const VkPipelineStageFlagBits Stage,
		Texture& Tex1, const cv::Mat CVImage1, const VkPipelineStageFlagBits Stage1) {
